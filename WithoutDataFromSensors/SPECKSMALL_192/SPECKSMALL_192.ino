...
byte key[] = {0x17, 0x16, 0x15, 0x14, 0x13, 0x12, 0x11, 0x10,
...
//      Serial.println(dataPacket[(16*i) + j]);
    ...
    cipherText = cipherText + encrypt(&speck, plainText ,24);
//    Serial.println("---------------------------------");
  }
  ...
  for(int i = 0; i < numberOfBlocks; i++)
  {
    ...
    decryptedText = decryptedText + decrypt(&speck, cipherBytesBlock ,24);
    Serial.println("---------------------------------");
  }
